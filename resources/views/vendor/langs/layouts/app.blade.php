		...
		<div class="row g-2 items-center">
			...
			<div class="col col-12 col-lg-6">
				<div class="flex">
					...
					<a @if(env('APP_STATUS') == 'Demo') href="javascript:void(0);" onclick="return toastr.info('This feature is disabled in Demo version.')" @else href="{{route('elseyyid.translations.lang.publishAll')}}" @endif class="btn btn-primary flex space-x-2">
