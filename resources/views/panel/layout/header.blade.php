                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ route('dashboard.user.openai.articlewizard.new') == url()->current() ? 'active' : '' }}"
                                ...
                                @if (env('APP_STATUS') == 'Demo')
                                    <span
                                        class="inline-flex items-center px-2 py-1 text-xs font-medium text-purple-700 rounded-md bg-purple-50 ring-1 ring-inset ring-purple-700/10">New</span>
                                @endif
                            </a>
                        </li>
                    @endif
