...
@section('title', $category->slug == 'ai_vision' ? __('Vision AI') : ($category->slug == 'ai_pdf' ? __('AI PDF') :
    ($category->slug == 'ai_chat_image' ? __('Chat Image') : __('AI Chat'))))
        ...
        <div class="container-xl">
            <div class="items-center row g-2">
                <div class="col">
                    ...
                    @section('title', $category->slug == 'ai_vision' ? __('Vision AI') : ($category->slug == 'ai_pdf' ?
                        __('AI PDF') : ($category->slug == 'ai_chat_image' ? __('Chat Image') : __('AI Chat'))))
                    </h2>
    ...
    <template id="chat_ai_bubble">
        <div class="lqd-chat-ai-bubble group mb-2 flex content-start gap-[8px]">
            ...
            <div
                ...
                <div
                    class=" !inline-flex !items-center !rounded-full !font-medium !leading-none !bg-white">
