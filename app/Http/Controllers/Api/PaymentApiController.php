    ...
    */
    public function cancelActiveSubscription(Request $request) {
        ...
        if($gatewayCode == 'stripe'){
            ...
            return self::convertBackWithToResponseJson(StripeController::subscribeCancel());
        }
        if($gatewayCode == 'paypal'){
            // return PaypalController::subscribeCancel();
            return self::convertBackWithToResponseJson(PaypalController::subscribeCancel());
        }
        if($gatewayCode == 'twocheckout'){
            // return TwoCheckoutController::subscribeCancel();
            return self::convertBackWithToResponseJson(TwoCheckoutController::subscribeCancel());
        }
        if($gatewayCode == 'paystack'){
            // return PaystackController::subscribeCancel();
            return self::convertBackWithToResponseJson(PaystackController::subscribeCancel());
        }
        if($gatewayCode == 'iyzico'){
            // return IyzicoController::subscribeCancel();
            return self::convertBackWithToResponseJson(IyzicoController::subscribeCancel());
        }
